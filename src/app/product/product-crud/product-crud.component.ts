...
export class ProductCrudComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private router: Router, private product_service: ProductService, private dataService: DataService) { }
  ...
  addNewProduct() {
    ...
    this.product_service.addNewProduct(this.product_dto).subscribe(data => {
      ...
      console.log('ProductComponent:DoCheck');
      console.log('ProductComponent:OnChanges');
    })
  }
